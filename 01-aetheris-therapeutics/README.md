...
Il repository è strutturato in tre macro-aree funzionali per riflettere le fasi operative di un vero ingaggio GRC:

### 📋 1. Fasi d'Audit & Working Papers (`/audit`)
* 📂 **`audit/Audit_Plan.md`**: Piano d'Audit formale secondo ISO 19011, perimetro dello SGSI, ruoli, responsabilità e calendario interviste.
* 📂 **`audit/Audit_Trail.md`**: Registro delle attività di fieldwork, trascrizione delle interviste chiave, campionamenti tecnici ed esame documentale.
...
* 📂 **`risk/Risk_Methodology.md`**: Metodologia di valutazione del rischio conforme a ISO 27005:2022 (Matrice 5x5 Probabilità x Impatto e Risk Appetite).
...
* 📂 **`risk/Risk_Treatment_Plan_RTP.md`**: Piano di Trattamento del Rischio (ISO 27001 Clausola 6.1.3) con allocazione budget (€ 70k), scadenze e criteri di re-audit.

### 📊 3. Executive Reporting & Board Governance (`/executive`)
* 📂 **`executive/Executive_Summary.md`**: Report strategico per il Board, il CEO e i C-Level con giustificazione finanziaria dell'investimento.
* 📂 **`executive/Maturity_Dashboard.md`**: Dashboard di maturità CMMI sui domini NIST CSF (Tier 1 -> Tier 3) e conformità controlli ISO 27001 Annex A.
* 📂 **`executive/Strategic_Roadmap_3-6-12.md`**: Roadmap strategica e operativa a 3, 6 e 12 mesi per il raggiungimento della certificazione ISO 27001.
